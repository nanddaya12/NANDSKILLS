<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all group">
            ...
            <div class="mt-5">
                <a href="{{ route('reports.exams') }}" class="w-full bg-purple-600 hover:bg-purple-700 text-white font-bold text-xs px-4 py-2.5 rounded-xl transition-all shadow-sm flex items-center justify-center gap-2">
                    ⬇ Download CSV
                </a>
            </div>
        </div>
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all group">
            ...
            <div class="mt-5">
                <a href="{{ route('reports.financial') }}" class="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs px-4 py-2.5 rounded-xl transition-all shadow-sm flex items-center justify-center gap-2">
                    ⬇ Download CSV
                </a>
            </div>
        </div>
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all group">
            ...
            <div class="mt-5">
                <a href="{{ route('reports.students') }}" class="w-full bg-sky-600 hover:bg-sky-700 text-white font-bold text-xs px-4 py-2.5 rounded-xl transition-all shadow-sm flex items-center justify-center gap-2">
                    ⬇ Download CSV
                </a>
            </div>
        </div>
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all group">
            ...
            <div class="mt-5">
                <a href="{{ route('reports.payroll') }}" class="w-full bg-amber-600 hover:bg-amber-700 text-white font-bold text-xs px-4 py-2.5 rounded-xl transition-all shadow-sm flex items-center justify-center gap-2">
                    ⬇ Download CSV
                </a>
            </div>
        </div>
        ...
        <div class="bg-white border border-rose-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all group">
            ...
            <form action="{{ route('reports.low_attendance') }}" method="GET" class="mt-5 space-y-3">
                <div>
                    <label class="block text-[10px] font-bold text-slate-400 uppercase tracking-wide mb-1">Attendance Threshold %</label>
